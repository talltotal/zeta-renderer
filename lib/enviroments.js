...
// 非测试环境可指定配置文件、端口号
if (env !== "test") {
  commander.version("renderer version: 0.0.3").usage("[options] [file], file default: renderer.json").option("-p, --port [port]", "Use the specified port, will override port config in config.json.");
